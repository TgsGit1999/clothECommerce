...
async function RegistrarUsuario({email,nombreCompleto,password,fechaNacimiento,direccionCalle,direccionNumero,codigoPostal,documento,telefonoCelular,ciudad}){
